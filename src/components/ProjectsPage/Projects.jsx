...
function Projects() {
    ...
    const projects = [
        ...
        new Project(2, "Recipe App", "Java, Spring Boot, Spring Security, JPA, MySQL", "RESTful API for a recipe app that I'm building as part of a personal project. It is secured using Spring Security and it uses JWTs in order to authenticate users. The database of choice for this project is MySQL. You can find a more detailed description and the progress on GitHub!", "GitHub", "https://upload.wikimedia.org/wikipedia/commons/9/91/Octicons-mark-github.svg", "https://github.com/mateipruteanu/RecipeAppBackend#readme"),
