...
function Card({index, title, languages, description, linkText, linkImage, link}) {
    ...
    const keywords = ["HTML", "CSS", "JS", "NodeJS", "microservice", "architecture", "screenshots", "GitHub", "personalized", "recommendations", "downloading", "TCP", "ReactJS", "Vercel", "Java", "RESTful", "API", "Spring Security", "JWTs", "MySQL", "demo", "NestJS", "NextJS", "PrismaORM", "MVC", "TypeScript", "Tailwind"];
